...
int BSTdistance(Node *root, int n1, int n2)
{
...
int main()
{
    ...
    cout << "Dist(4, 5) = " << BSTdistance(root, 4, 5);
    cout << "\nDist(4, 6) = " << BSTdistance(root, 4, 6);
    cout << "\nDist(3, 4) = " << BSTdistance(root, 3, 4);
    cout << "\nDist(2, 4) = " << BSTdistance(root, 2, 4);
    cout << "\nDist(8, 5) = " << BSTdistance(root, 8, 5);
    return 0;
}
